<template>
  <div>
    <div style="width: 400px" class="my-3 ms-auto me-auto p-3 form-container">
      <b-row class="my-4">
        <div class="ms-auto me-auto p-2 h3" style="width: 110px">Sign Up</div>
      </b-row>
      <b-row class="my-4">
        <b-col sm="3">
      ...
      <b-row class="my-4">
        <b-button size="lg" @click.prevent="signUp" class="inline-button"
          >Sign Up</b-button
        >
      </b-row>
